...
use mania_core::core::event::message::file_c2c_download::FileC2CDownloadEvent;
use mania_core::core::event::message::file_group_download::FileGroupDownloadEvent;
use mania_core::core::event::message::image_c2c_download::ImageC2CDownloadEvent;
use mania_core::core::event::message::image_group_download::ImageGroupDownloadEvent;
use mania_core::core::event::message::multi_msg_download::MultiMsgDownloadEvent;
use mania_core::core::event::message::record_c2c_download::RecordC2CDownloadEvent;
use mania_core::core::event::message::record_group_download::RecordGroupDownloadEvent;
use mania_core::core::event::message::send_message::SendMessageEvent;
use mania_core::core::event::message::video_c2c_download::VideoC2CDownloadEvent;
use mania_core::core::event::message::video_group_download::VideoGroupDownloadEvent;
use mania_core::core::event::system::fetch_filtered_group_request::FetchFilteredGroupRequestsEvent;
use mania_core::core::event::system::fetch_group_requests::FetchGroupRequestsEvent;
use mania_core::core::event::system::fetch_rkey::FetchRKeyEvent;
use mania_core::core::event::system::fetch_user_info::FetchUserInfoEvent;
use mania_core::core::event::{downcast_major_event, downcast_mut_major_event};
use mania_core::core::protos::service::oidb::IndexNode;
use mania_core::dda;
use mania_core::entity::bot_group_request::BotGroupRequest;
use mania_core::message::chain::MessageChain;
use std::sync::Arc;
use tokio::join;

impl BusinessHandle {
    pub async fn fetch_rkey(self: &Arc<Self>) -> BusinessResult<()> {
    ...
    pub async fn download_multi_msg(
        self: &Arc<Self>,
        uid: String,
        res_id: String,
    ) -> BusinessResult<Option<Vec<MessageChain>>> {
        ...
        let event: &mut MultiMsgDownloadEvent =
            downcast_mut_major_event(&mut res).ok_or(BusinessError::InternalEventDowncastError)?;
    ...
    pub async fn fetch_group_requests(self: &Arc<Self>) -> BusinessResult<Vec<BotGroupRequest>> {
    ...
    pub async fn send_message(self: &Arc<Self>, message: MessageChain) -> BusinessResult<()> {
